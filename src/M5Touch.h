...
== M5Touch - The M5Stack Tough Touch Library ==

  This is the library behind the M5.Touch object that you can use to read
  from the touch sensor on the M5Stack Tough. It was made to be an input
...
== About the Touch Sensor in the M5Stack Tough ==
  ...
  The touch sensor extends to below the screen of the Tough: the sensor maps
...
== Buttons, Gestures, Events ==
  ...
  / M5Tough / Touch" in your Arduino environment should give you an
...
== Legacy API ==
  ...
  Buttons. This older API is still supported (the M5Tough Factory Test sketch
...
== Example ==
  ...
  Under File / Examples / M5Tough / Touch in your Arduino environment is an
...
class M5Touch {
 public:
  ...
  void readRegisters(uint8_t reg, uint8_t size, uint8_t* data);
...
// For compatibility with older M5Tough code
