...
== M5Button: Buttons, Gestures and Events ==
  ...
  * Buttons on the screen, either as labels above the original M5Stack's
    hardware buttons or anywhere on the touch screen of the Tough.
...
== Buttons ==
  ...
  the controller. On the M5Stack Tough, you can also create buttons that act
  ...
  Whether on the M5Stack with hardware buttons or on the Tough with a touch
...
== Hardware Buttons ==
  ...
  wire for the touch screen on the Tough, it also happens to output a star on
...
== Buttons Using the Touch Screen ==
  ...
  On the Tough the three buttons M5.BtnA, M5.BtnB and M5.BtnC from the older
...
== Events ==
  ...
  Here's an events-based sketch for the Tough. We'll base it on the same
...
== Advanced Hints and Tricks
  ...
  ## drawZone
    ...
    buttons on the Tough on the screen just above their touch areas.
...
#ifdef M5Stack_M5Tough
#include <M5Touch.h>
#endif /* M5Stack_M5Tough */
