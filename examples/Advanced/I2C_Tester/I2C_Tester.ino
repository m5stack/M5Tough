...
void setup()
{
  M5.begin(true,true,true,true); //Init M5Tough(Initialization of external I2C is also included).  初始化M5Tough(初始化外部I2C也包含在内)
  ...
  M5.Lcd.println("M5Tough I2C Tester"); //Print a string on the screen.  在屏幕上打印字符串
  delay(3000);
