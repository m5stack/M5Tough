...
* date：2021/7/29
*******************************************************************************
  M5Tough will sends a message to a TCP server
  M5Tough 将向TCP服务器发送一条数据
*/
...
void setup()
{
  ...
  M5.lcd.println(WiFi.localIP()); //The serial port outputs the IP address of the M5Tough.  串口输出M5Tough的IP地址
  delay(500);
}
