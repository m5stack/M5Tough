...
*                 Equipped with M5Stack Tough sample source code
*                          配套  M5Stack Tough 示例源代码
...
* 
* Please follow the steps below to change the partition scheme before compiling:
* 在烧录前请按以下步骤更改分区表:
* - Arduino menu --> Tools --> Partition Scheme --> 8M Flash (3Mb APP/1.5MB FAT)
*
